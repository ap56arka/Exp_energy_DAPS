...
from diff_sde import schedule
from diff_sde.model import GaussianFourierProjection, Dense, SiLU, mlp
...
class Bandit_ScoreBase(nn.Module):
    ...
    def forward_dmp_wrapper_fn(self, x, t):
        ...
        #Removr everything after score to perform normal sampling
